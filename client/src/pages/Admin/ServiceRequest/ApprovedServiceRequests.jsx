  ...
  const navigation = useNavigate();
    ...
    useEffect(() => {
      const fetchLockers = async () => {
        try {
          const response = await axios.get(`${API_URL}/api/v1/user/aproved-request`);
    ...
    <Layout>
        <div className="row">
            ...
            <div className="col-md-10">
                <h1> Approved User Service Requests</h1>
                ...
                <table className="table table-striped table-hover">
                    ...
                    <th name="id">Request ID</th>
                        ...
                        <th name="contuserMessageact">Admin Message</th>
                    ...
                    {users.length > 0 ? (
                                   ...
                                   <tr>
                                     <td colSpan="8" className="text-center">
                                       No Approved User Service Requests available.
                                     </td>
                                   </tr>
                                 )}
                    </tbody>
