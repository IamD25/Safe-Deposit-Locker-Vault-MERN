...
const PaymentEntry = () => {
  ...
  // State for payment status and method options
const [paymentStatusOptions] = useState(["Paid", "Due"]);
const [paymentMethodOptions] = useState(["Cash", "UPI", "Card"]);
      ...
      <div className="row ">
        ...
        <div id="useridin" className="row my-2 ">
            ...
            <form id="assign" action method="POST">
              <div className="row check my-2 m-2">
                <div className="row m-2">
                  <label htmlFor="rent" className="col-sm-2 form-label">
                    Amount
                  </label>
                ...
                <div className="row m-2">
                  <label htmlFor="paymentDate" className="col-sm-2 form-label">
                    Payment Date
                  </label>
                  <div className="col-sm-4">
                    <input
                  ...
                  <label htmlFor="dueDate" className="col-sm-2 form-label">
                    Due Date
                  </label>
                  <div className="col-sm-4">
                    <input
                ...
                <div className="row m-2">
                  {/* Payment Status */}
                  <label htmlFor="paymentStatus" className="col-md-2">
                    Payment Status
                  </label>
                  <div className="col-md-4">
                    ...
                    <small className="paymentstatus">Please Select Payment Status</small>
                  </div>

                  {/* Payment Method */}
                  <label htmlFor="paymentMethod" className="col-md-2">
                    Payment Method
                  </label>
                  <div className="col-md-4">
                    <select
                    ...
                    <small className="paymentmethod">Please Select Payment Method</small>
                  </div>
                </div>
