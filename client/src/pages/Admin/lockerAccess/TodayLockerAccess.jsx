       ...
       const [access, setAccess] = useState([]);
        ...
        useEffect(() => {
          const fetchAccess = async () => {
            try {
              const response = await axios.get(`${API_URL}/api/v1/access/today-locker-access`);
    ...
    <div className="row">
        ...
        <div>
                    <div className="row">
                        ...
                        <h1 className="h2">Today's Locker Check In and Check Out Transaction</h1>
                        </div>
...
export default TodayLockerAccess
